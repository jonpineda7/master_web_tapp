...
public class migracionActions {
    ...
    public void cFinanciera(String sheetName, int row) {
        ...
        // Obtenemos el número de cuenta primero para usarlo en el mensaje de error si
        // es necesario
        ...
        try {
            ...
            wu.type(numeroCuenta, valorFiltro);
            ...
            wu.clickWhenReady(ctaFin);
            wu.waitForProcessingToComplete(10);

            System.out.println("Éxito: Se encontró y se hizo clic en la cuenta: " + numeroCuenta);

        } catch (NoSuchElementException | TimeoutException e) {
            // Este bloque se ejecuta si cualquier fluentWait o clickWhenReady no encuentra
            // el elemento
            System.err.println("FINALIZANDO PRUEBA: No se encontró el número de cuenta '" + ctaFin
                    + "' después de aplicar el filtro.");

            // Opción A: Lanza una excepción para que el framework de pruebas (JUnit/TestNG)
            // la marque como fallida.
            // Esta es la MEJOR PRÁCTICA.
            throw new RuntimeException("No se encontró el número de cuenta: " + ctaFin, e);

            // Opción B: Termina abruptamente todo el proceso Java. (No recomendado para
            // tests)
            // System.exit(1);
    ...
    public String validarRegistros(String RutEsperado, String cuentaEsperado, String PlazoEsperado,
            String estadoEsperado, String montoEsperado,
        ...
        // String caeOriginalResp =
        // caeOriginal.getAttribute("value").trim().replace(",", ".");
        ...
        if (!rutResp.equals(RutEsperado)) {
            resultado.append("Rut NOK (esperado: ").append(RutEsperado).append("| encontrado: ").append(rutResp)
                    .append("),");
        }

        if (!cuentaResp.equals(cuentaEsperado)) {
            resultado.append("Cuenta NOK (esperado: ").append(cuentaEsperado).append("| encontrado: ")
                    .append(cuentaResp).append("),");
        }

        if (!cuotaResp.equals(PlazoEsperado)) {
            resultado.append("PLazo NOK (esperado: ").append(PlazoEsperado).append("| encontrado: ").append(cuotaResp)
                    .append("),");
        }
        /*
         * if (!intAnualResp.equals(intAnualEsperado)) {
         * resultado.append("intAnual NOK (esperado: ").append(intAnualEsperado).
         * append("| encontrado: ,").append(intAnualResp).append(",); ");
         * }
         * 
         * if (!intMensualResp.equals(intMensualEsperado)) {
         * resultado.append("intMensual NOK (esperado: ").append(intMensualEsperado).
         * append("| encontrado: ,").append(intMensualResp).append(",); ");
         * }
         */

        if (!estadoResp.equals(estadoEsperado)) {
            resultado.append("estado NOK (esperado: ").append(estadoEsperado).append("| encontrado: ")
                    .append(estadoResp).append("),");
        }

        if (!montoResp.equals(montoEsperado)) {
            resultado.append("monto NOK (esperado: ").append(montoEsperado).append("| encontrado: ").append(montoResp)
                    .append("),");
        }

        if (!sucResp.equals(sucEsperado)) {
            resultado.append("sucursal NOK (esperado: ").append(sucEsperado).append("| encontrado: ").append(sucResp)
                    .append("),");
        }

        if (!cProdResp.equals(cProdEsperado)) {
            resultado.append("cProd NOK (esperado: ").append(cProdEsperado).append("| encontrado: ").append(cProdResp)
                    .append(");,");
        }

        if (!monedaResp.equals(monedaEsperado)) {
            resultado.append("moneda NOK (esperado: ").append(monedaEsperado).append("| encontrado: ")
                    .append(monedaResp).append("),");
        }

        if (!mImpResp.equals(mImpEsperado)) {
            resultado.append("mImp NOK (esperado: ").append(mImpEsperado).append("| encontrado: ").append(mImpResp)
                    .append("),");
        }

        if (!mGasResp.equals(mGasEsperado)) {
            resultado.append("mGas NOK (esperado: ").append(mGasEsperado).append("| encontrado: ").append(mGasResp)
                    .append("),");
        }

        if (!mProyResp.equals(mProyEsperado)) {
            resultado.append("mProy NOK (esperado: ").append(mProyEsperado).append("| encontrado: ").append(mProyResp)
                    .append("),");
        }

        if (!capIniResp.equals(capIniEsperado)) {
            resultado.append("capIni NOK (esperado: ").append(capIniEsperado).append("| encontrado: ")
                    .append(capIniResp).append("),");
        }

        /*
         * if (!caeOriginalResp.equals(caeOriginalEsperado)) {
         * resultado.append("caeOriginal NOK (esperado: ").append(caeOriginalEsperado).
         * append("| encontrado: ,").append(caeOriginalResp).append(",); ");
         * }
         * 
         * if (!caeSinSegResp.equals(caeSinSegEsperado)) {
         * resultado.append("caeSinSeg NOK (esperado: ").append(caeSinSegEsperado).
         * append("| encontrado: ,").append(caeSinSegResp).append(",); ");
         * }
         */

        /*
         * if (!apellidoPResp.equals(apellidoPEsperado)) {
         * resultado.append("apellidoP NOK (esperado: ").append(apellidoPEsperado).
         * append("| encontrado: ,").append(apellidoPResp).append(",); ");
         * }
         * if (!apellidoMResp.equals(apellidoMEsperado)) {
         * resultado.append("apellidoM NOK (esperado: ").append(apellidoMEsperado).
         * append("| encontrado: ,").append(apellidoMResp).append(",); ");
         * }
         * 
         * if (!nombreResp.equals(nombreEsperado)) {
         * resultado.append("nombre NOK (esperado: ").append(nombreEsperado).
         * append("| encontrado: ,").append(nombreResp).append(",); ");
         * }
         */
    ...
    public void cPago() {
        wu.fluentWait(btnCuadroPago).click();
        wu.waitForProcessingToComplete(10);
        if (!wu.isElementPresent(btnUltimaCuota)) {
            System.out.println("boton tabla no presente");
        } else {
            wu.clickWhenReady(btnUltimaCuota);
            wu.waitForProcessingToComplete(5);
        }
